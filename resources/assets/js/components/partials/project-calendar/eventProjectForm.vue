<template>
  <ModalComponent :showModal="show" @close="toggleEventForm"> 
      ...
      <div class="flex flex-row justify-end pt-6 px-8 bg-gray-100 rounded">
        ...
        <baseButton  @click="saveForm" :btnDisabled="event.title.length === 0 || event.url.length === 0 || event.classes.length === 0 || !event.endDate || !event.startDate" btnType="primary">Guardar</baseButton>
      </div>
    </ModalComponent>
</template>
