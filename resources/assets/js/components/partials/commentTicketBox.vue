  ...
  methods: {
    ...
    saveComment (e) {
      if (e.shiftKey) {
        ...
        axios.post('/tickets/comments', {
          body: this.body,
          commentable_type: this.resourceType,
          commentable_id: this.resourceId,
          group_type: this.parentGroupType ? this.parentGroupType : this.groupType,
          group_id: this.parentGroupId ? this.parentGroupId : this.groupId,
    ...
    deleteComment (comment, index) {
      axios.delete('/tickets/comments/' + comment.id)
        .then((response) => {
